...
prompt ====================
prompt Total time
select grand_total/1000000 as grand_total
...
select runid,
       ...
       run_total_time/1000000 as secs
...
select p1.total_time/10000 as hsecs,
        p1.total_time/p4.grand_total*100 as pct,
